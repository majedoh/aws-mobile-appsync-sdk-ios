Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/oahhariri/aws-mobile-appsync-sdk-ios.git',
                     :tag => s.version }
  s.requires_arc = true
  ...
  s.dependency 'AppSyncRealTimeClient', :git => 'https://github.com/oahhariri/aws-appsync-realtime-client-ios.git'
